...
class ColumnsSeparator:
    ...
    def separate_cells_in_columns(self, table_image: ndarray) -> Tuple[ndarray, List[Column]]:
        ...
        self.save_table_contours_to_file(contours_definer_rotated_table)

        new_table_image, fixed_table_contours_image = \
        ...
        return new_table_image, cells_in_columns

    def _create_rotated_table_image(self, table_image: ndarray) -> ndarray:
        table_binary = self._image_to_binary(table_image)
        contours_definer_original_table = ContoursDefiner(table_binary)
        rotated_table_image = self.__image_rotator.rotate_image(table_image,
                                                                contours_definer_original_table.get_horizontal_lines())
        return rotated_table_image
    ...
    def save_table_contours_to_file(self, contours_definer_rotated_table: ContoursDefiner) -> None:
    ...
    def _get_fixed_table_contours_image(self, rotated_table_image: ndarray, contours_definer_on_rotated: ContoursDefiner) -> Tuple[ndarray, ndarray]:
        ...
        new_table_image = self._remove_redundant_table_part(rotated_table_image, fixed_table_contours_image)
        return new_table_image, fixed_table_contours_image
